...
#include "GMASEx_MMPawn_Base.generated.h"

/**
 * @class AGMASEx_MMPawn_Base
 ...
 */
UCLASS()
class GMASEX_MM_API AGMASEx_MMPawn_Base : public AGMC_Pawn, public IGMCE_MotionWarpSubject
{
	GENERATED_BODY()

public:
	AGMASEx_MMPawn_Base(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
...
protected:
	...
	TObjectPtr<UGMASEx_MMMovementComponent> MovementComponent;
