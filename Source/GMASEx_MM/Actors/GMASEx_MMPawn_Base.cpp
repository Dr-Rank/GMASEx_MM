...
AGMASEx_MMPawn_Base::AGMASEx_MMPawn_Base(const FObjectInitializer& ObjectInitializer) :
...
void AGMASEx_MMPawn_Base::BeginPlay()
{
	Super::BeginPlay();
	
	MovementComponent = GetComponentByClass<UGMASEx_MMMovementComponent>();
...
void AGMASEx_MMPawn_Base::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
...
void AGMASEx_MMPawn_Base::Respawn()
{
...
void AGMASEx_MMPawn_Base::Respawn_Internal()
{
...
void AGMASEx_MMPawn_Base::CL_Respawn_Implementation()
{
...
void AGMASEx_MMPawn_Base::SV_Respawn_Implementation()
{
	Respawn_Internal();
}

void AGMASEx_MMPawn_Base::OnRespawnCallback()
{
...
void AGMASEx_MMPawn_Base::OnRespawn_Implementation()
{
}

USkeletalMeshComponent* AGMASEx_MMPawn_Base::MotionWarping_GetMeshComponent() const
{
	return MotionWarpingMeshComponent;
}

float AGMASEx_MMPawn_Base::MotionWarping_GetCollisionHalfHeight() const
{
...
FQuat AGMASEx_MMPawn_Base::MotionWarping_GetRotationOffset() const
{
...
FVector AGMASEx_MMPawn_Base::MotionWarping_GetTranslationOffset() const
{
...
FAnimMontageInstance* AGMASEx_MMPawn_Base::GetRootMotionAnimMontageInstance(
...
UGMCE_OrganicMovementCmp* AGMASEx_MMPawn_Base::GetGMCExMovementComponent() const
{
