...
#include "GMASEx_MMAnimInstance.h"

void UGMASEx_MMAnimInstance::ObtainComponents()
{
	if (!IsValid(GMCPawn) || !IsValid(MovementComponent))
	{
		...
		if (!GetWorld()->IsGameWorld())
		{
			...
			MovementComponent = Cast<UGMASEx_MMMovementComponent>(GMCPawn->GetMovementComponent());

			if (!MovementComponent)
			{
				MovementComponent = NewObject<UGMASEx_MMMovementComponent>();
			}
		...
		{
			MovementComponent = Cast<UGMASEx_MMMovementComponent>(GMCPawn->GetComponentByClass<UGMCE_OrganicMovementCmp>());
		}
	}	
}


void UGMASEx_MMAnimInstance::NativeInitializeAnimation()
{
...
void UGMASEx_MMAnimInstance::NativeBeginPlay()
{
...
void UGMASEx_MMAnimInstance::NativeUpdateAnimation(float DeltaSeconds)
{
