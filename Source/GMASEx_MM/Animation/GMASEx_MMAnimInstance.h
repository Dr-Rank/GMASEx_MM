...
#include "GMASEx_MMAnimInstance.generated.h"

/**
 * 
 */
UCLASS()
class GMASEX_MM_API UGMASEx_MMAnimInstance : public UGMCAbilityAnimInstance
{
	GENERATED_BODY()
...
public:
	...
	UGMASEx_MMMovementComponent* MovementComponent;
